...
describe('CSP Security Policy', () => {
    it('should have the correct CSP for Google TTS in index.html', () => {
        ...
        const expectedCSP = "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data:; connect-src 'self' https://*.googleapis.com https://*.google.com; media-src 'self' https://translate.google.com; font-src 'self' https://fonts.gstatic.com; form-action 'self'; base-uri 'self'; object-src 'none';";
